...
namespace ProBot.Attributes
{
    [AttributeUsage(AttributeTargets.Method | AttributeTargets.Class, AllowMultiple = false )]
    public class RequireCategoriesAtrribute : CheckBaseAttribute
    {
        public IReadOnlyList<string> CategoryNames { get; }
        public ChannelCheckMode CheckMode { get; }

        public RequireCategoriesAtrribute(ChannelCheckMode checkMode, params string[] channelNames)
        {
            CheckMode = checkMode;
        ...
        public override Task<bool> ExecuteCheckAsync(CommandContext ctx, bool help)
        {
            ...
            bool contains = CategoryNames.Contains(ctx.Channel.Parent.Name,
